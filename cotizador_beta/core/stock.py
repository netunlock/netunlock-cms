...
def necesidad_de_despiece(db, despiece, cantidad: int = 1) -> Requerimiento:
    ...
    * **Accesorios**: la cantidad ya resuelta por el kit, en su propia unidad.
    ...
    # Las N unidades se optimizan JUNTAS. Sacar las barras de una y multiplicar
    # por N descuenta de más: tres ventanas iguales cuyo parante mide 1 m salen
    # de una barra de 6, no de tres.
    for barras in optimizar_conjunto([(despiece.aluminio.piezas, cantidad)]):
        ...
        req.lineas.append(Necesidad(
            ...
            unidad="barras", requerido=barras.cantidad,
