...
EXCLUIR = [
    ...
    # Herramientas de desarrollo. No se pueden disparar desde la interfaz, pero
    # escriben en la base del usuario: no tienen nada que hacer en el paquete.
    "tools.escenario_stock", "tools.comparar_produccion", "tools.prueba_rapida",
    "tools.precios_demo",
