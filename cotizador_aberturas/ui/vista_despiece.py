...
class VentanaDespiece(DialogoBase):
    def __init__(self, master, despiece, titulo: str = ""):
        super().__init__(master, f"Despiece — {titulo}", ancho=1000)
    ...
    def _resumen(self, master):
        ...
        self.barras_por_perfil = optimizar_por_perfil(al.piezas)
    ...
    def _detalle(self, master):
        ...
        ctk.CTkLabel(
            hoja,
            text="Cada perfil se corta de su propia barra. El sobrante de un perfil "
                 "no sirve para otro, por eso se cuentan por separado.",
